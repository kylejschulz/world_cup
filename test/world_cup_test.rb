...
class World_Cuptest < Minitest::Test
  def setup
    ...
    @modric = Player.new({name: "Luka Modric", position: "midfielder"})    # => #<Player:0x00007f936a3595f8...>
    @vida = Player.new({name: "Domagoj Vida", position: "defender"})    # => #<Player:0x00007f936a318f08...>
    @croatia.add_player(@modric)
    @croatia.add_player(@vida)
    @world_cup = WorldCup.new(2018, [@france, @croatia])    # => #<WorldCup:0x00007f936a010d10...>
  end
  ...
  def test_active_players_by_positoin
    ...
    assert_equal [@pogba], @world_cup.active_players_by_position("midfielder")# => [#<Player:0x00007f936c035eb0...>]
  end
